...
class SucesosDnDataAccess implements IDataAccess<ISucesosDn> {
    ...
    get(): Promise<IErrorResponse | Array<ISucesosDn>> {
     ...
     * @returns 
     */
    async insert(data: ISucesosDn): Promise<ISucesosDn | IErrorResponse> {
     ...
     * @returns 
     */
    async getByUserSuceso(idUser: BigInt): Promise<IErrorResponse | Array<ISucesosDn>> {
        // throw new Error("Method not implemented.")
        const queryData  = {
        ...
        let lData: Array<ISucesosDn | IErrorResponse> = (await this.client.exeQuery(queryData)) as Array<ISucesosDn | IErrorResponse>
...
export default SucesosDnDataAccess
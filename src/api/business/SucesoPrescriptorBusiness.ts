...
import SucesoPrescriptorDataAccess from "../data/SucesoPrescriptorDataAccess"
import { ISucesoPrescriptor } from "../models/ISucesoPrescriptor"

class SucesoPrescriptorBusiness implements IDataAccess<ISucesoPrescriptor> {
    public dataAccess: SucesoPrescriptorDataAccess
    
    constructor(      public idUserLogin: BigInt,
                    public filterStatus: StatusDataType,
                    public isTransactions: boolean, 
                    public infoExtra?: any) {
        this.dataAccess = new SucesoPrescriptorDataAccess(idUserLogin, filterStatus, isTransactions, infoExtra)
    }

    get(): Promise<Array<ISucesoPrescriptor> | IErrorResponse> {
        throw new Error("Method not implemented.")
    }

    getById(id: BigInt): Promise<ISucesoPrescriptor | IErrorResponse> {
        throw new Error("Method not implemented.")
    }

    private validate(data: ISucesoPrescriptor, error: IErrorResponse): void {
        // // descripcion
    ...
    insert(data: ISucesoPrescriptor): Promise<ISucesoPrescriptor | IErrorResponse> {
        throw new Error("Method not implemented.")
    ...
    update(id: BigInt, data: ISucesoPrescriptor): Promise<ISucesoPrescriptor | IErrorResponse> {
        throw new Error("Method not implemented.")
    }

    delete(id: BigInt): Promise<ISucesoPrescriptor | IErrorResponse> {
        throw new Error("Method not implemented.")
    }

    getByGrupoId(idGrupo: BigInt): Promise<IErrorResponse | Array<ISucesoPrescriptor>> {
        return this.dataAccess.getByGrupoId(idGrupo)
    }
}

export default SucesoPrescriptorBusiness
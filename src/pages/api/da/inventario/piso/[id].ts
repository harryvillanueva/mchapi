...
.get(async ( req, res : NextApiResponse <IResponse | IErrorResponse>) =>{
    ...
    let el : InventarioBusiness = new InventarioBusiness(idUserLogin, filterState, false , {filter : dataFilter})
    let dataDB: Array <IInventario> | IErrorResponse = await el.getByIdPiso(BigInt(parseInt(req.query.id as string)))

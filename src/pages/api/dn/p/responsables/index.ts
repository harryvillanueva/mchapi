...
const handler = nc(
    ...
    .get(async (req, res: NextApiResponse<IResponse | IErrorResponse>) => { 
        ...
        let el: ResponsableLeadBusiness = new ResponsableLeadBusiness(idUserLogin, filterState, false, { filter: dataFilter })
        let dataDB: Array<IResponsableLead> | IErrorResponse = await el.getAllWithPagination()

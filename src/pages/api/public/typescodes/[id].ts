...
import TypeCodeBusiness from '@/api/business/TypeCodeBusiness'
import { ITypeCode } from '@/api/models/ITypeCode'
...
const handler = nc(
    ...
    .get(async (req, res: NextApiResponse<IResponse | IErrorResponse>) => { 
        ...
        let el: TypeCodeBusiness = new TypeCodeBusiness(idUserLogin, filterState, false)
        
        let dataDB: ITypeCode | IErrorResponse = await el.getById(BigInt(parseInt(req.query.id as string)))
        if ( !dataDB ) {

...
const handler = nc(
      ...
      .get(async (req, res: NextApiResponse<IResponse | IErrorResponse>) => {
            ...
            let el:ApartmentBusiness = new ApartmentBusiness(idUserLogin, filterStatus, false)
            let dataDB: Array<IApartment> | IErrorResponse = await el.getAllByUser(idUserLogin)
